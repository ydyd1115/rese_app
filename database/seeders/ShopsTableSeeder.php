...
Shop::create($param);$param = ['name' => '牛助',
'area' => '大阪府',
'genre' => '焼肉',
...
Shop::create($param);$param = ['name' => '戦慄',
'area' => '福岡県',
'genre' => '居酒屋',
...
Shop::create($param);$param = ['name' => 'ルーク',
'area' => '東京都',
'genre' => 'イタリアン',
...
Shop::create($param);$param = ['name' => '志摩屋',
'area' => '福岡県',
'genre' => 'ラーメン',
